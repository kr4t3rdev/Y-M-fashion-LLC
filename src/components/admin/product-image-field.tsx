  ...
  return (
    <div className="grid gap-2">
      ...
      <UploadButton
        ...
        appearance={{
          button:
            "h-9 w-full rounded-md border border-hairline bg-foreground text-sm font-medium text-background " +
      ...
      {imageUrl && (
        <div className="relative aspect-[4/5] w-40 overflow-hidden rounded-md border border-hairline bg-muted">
